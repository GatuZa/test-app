				...
				<div class="form-container">
					...
					<fieldset>
						<div class="form-group">
							<?= $form->error($model, 'varName', ['class' => 'alert alert-danger']); ?>
							<?= $form->error($model, 'varPassword', ['class' => 'alert alert-danger']); ?>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<span class="input-group-addon">
								...
								<?=
								$form->passwordField($model, 'varPassword', [
									'class' => 'form-control',
