...
var RLANG = {
	...
	quote: 'Кавычки',
	code: 'Code',
	header1: 'Заглавие 1-го уровня',
	header2: 'Заглавие 2-го уровня',
	header3: 'Заглавие 3-го уровня',
	header4: 'Заглавие 4-го уровня',
	bold:  'Жирный',
	italic: 'Курсивный',
	fontcolor: 'Цвет шрифта',
	backcolor: 'Цвет фона',
	unorderedlist: 'Маркированый список',
	...
	insert_row_above: 'Добавить колонку выше',
	insert_row_below: 'Добавить колонку ниже',
	insert_column_left: 'Добавить столбец слева',
	insert_column_right: 'Добавить столбец справа',
	delete_column: 'Удалить столбец',
	delete_row: 'Удалить колонку',
	delete_table: 'Удалить таблицу',
	rows: 'Колонки',
	columns: 'Столбцы',
	add_head: 'Добавить заглавие',
	delete_head: 'Удалить заглавие',
	title: 'Заглавие',
	image_position: 'Позиция',
	none: 'Нет',
	left: 'Лево',
	right: 'Право',
	image_web_link: 'URL изображения',
	text: 'Текст',
	mailto: 'E-mail',
	web: 'URL',
	...
	drop_file_here: 'Бросьте файл сюда',
	...
	deleted: 'Удален',
	anchor: 'Якорь',
	link_new_tab: 'Открыть ссылку в вкладке',
	...
	var Redactor = function(element, options)
	{
		...
		this.opts = $.extend({
			...
			allowedTags: ["form", "input", "button", "select", "option", "datalist", "output", "textarea", "fieldset", "legend",
				"section", "header", "hgroup", "aside", "footer", "comment", "details", "nav", "progress", "time", "canvas",
			...
			buttonsCustom: {},
			buttonsAdd: [],
			buttons: ['html', '|', 'alignleft', 'aligncenter', 'alignright', 'justify', '|', 'bold', 'italic', 'deleted', 'underline', '|', 'unorderedlist', 'orderedlist', 'outdent', 'indent', '|',
				'image', 'video', 'file', 'table', 'link', '|',
				'fontcolor', 'backcolor', '|', 'alignment', '|', 'horizontalrule', '|', 'formatting' ],
